...
ActiveRecord::Schema.define(version: 20150928054158) do
  ...
  add_index "profit_losses", ["cost_id", "sales_id"], name: "index_profit_losses_on_cost_id_and_sales_id"
  ...
  add_index "profit_losses", ["sales_id", "cost_id"], name: "index_profit_losses_on_sales_id_and_cost_id"
  add_index "profit_losses", ["sales_id"], name: "index_profit_losses_on_sales_id"
  ...
  add_index "sales_details", ["sales_id"], name: "index_sales_details_on_sales_id"
